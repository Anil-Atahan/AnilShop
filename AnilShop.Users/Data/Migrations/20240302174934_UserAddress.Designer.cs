...
namespace AnilShop.Users.Data.Migrations
{
    ...
    [Migration("20240302174934_UserAddress")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AnilShop.Users.CartItem", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("AnilShop.Users.UserStreetAddress", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ComplexProperty<Dictionary<string, object>>("StreetAddress", "AnilShop.Users.UserStreetAddress.StreetAddress#Address", b1 =>
                        {
                            b1.IsRequired();
            ...
            modelBuilder.Entity("AnilShop.Users.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("AnilShop.Users.CartItem", b =>
                {
                    b.HasOne("AnilShop.Users.ApplicationUser", null)
                        .WithMany("CartItems")
